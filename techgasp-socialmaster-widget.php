...
class techgasp_socialmaster_widget extends WP_Widget {
	...
	$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'techgasp_socialmaster_widget' );
	$this->WP_Widget( 'techgasp_socialmaster_widget', __('Social Master', 'social master'), $widget_ops, $control_ops );
	}
	...
	//Display Twitter
	if ( $show_twitter )
			echo '<center><a href="https://twitter.com/'.$twitter_user.'" class="twitter-follow-button" data-show-count="false" data-show-screen-name="false"></a>' .
	...
	$defaults = array( 'name' => __('Social Master', 'social master'), 'title' => true, 'show_facebook' => false, 'facebook_display' => false, 'facebook_page' => false, 'facebook_id' => false, 'show_twitter' => false, 'twitter_user' => false, 'show_google' => false );
	...
	<label for="<?php echo $this->get_field_id( 'facebook_display' ); ?>"><?php _e('Activate to Show Fanpage Total Count', 'social master'); ?></label></br>
	<p>
	<label for="<?php echo $this->get_field_id( 'facebook_page' ); ?>"><?php _e('insert Facebook Page link (if above Total Count is selected):', 'social master'); ?></label></br>
	...
	<hr>
		<!--LINKEDIN-->
	<p><b>LinkedIn Options, Upgrade to Advanced Version.</b></p>
	<hr>
		<!--TUMBLR-->
	<p><b>Tumblr Options, Upgrade to Advanced Version.</b></p>
	<hr>
		<!--YOUTUBE-->
	...
	<hr>
		<!--PINTEREST-->
	<p><b>Pinterest Options, Upgrade to Advanced Version.</b></p>
	<hr>
		<!--STUMBLEUPON-->
	<p><b>StumbleUpon Options, Upgrade to Advanced Version.</b></p>
	<hr>
		<!--BUFFER-->
	<p><b>Buffer Options, Upgrade to Advanced Version.</b></p>
	<hr>
		<!--REDDIT-->
	<p><b>Reddit Options, Upgrade to Advanced Version.</b></p>
	<hr>
		<!--NETWORKS-->
