...
<h2><?php _e("Social Master LITE Version", 'social_master'); ?></h2>
<br>
...
<br>
<div class="description">Only available in <b>Social Master Advanced Version</b>.</div>
</fieldset>
...
<div class="description">The shortcode framework allows you to insert Social Master inside Pages & Posts without the need of extra plugins or gimmicks. Fast page load times and top SEO. Only available in <b>Social Master Advanced Version</b>.</div>
<br>
<div style="background: url(<?php echo plugins_url('../images/techgasp-hr.png', __FILE__); ?>) repeat-x; height: 10px"></div>
